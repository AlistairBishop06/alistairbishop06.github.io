...
const defaults: Record<WindowKind, { title: string; icon: IconName; rect: Rect }> = {
  ...
  display: { title: 'Display Properties', icon: 'control', rect: { x: 250, y: 100, width: 520, height: 455 } },
  ...
  run: { title: 'Run', icon: 'app', rect: { x: 300, y: 180, width: 420, height: 205 } },
  shutdown: { title: 'Turn off computer', icon: 'windows', rect: { x: 275, y: 155, width: 480, height: 300 } },
  ...
  documents: { title: 'My Documents', icon: 'folder', rect: { x: 190, y: 90, width: 650, height: 450 } },
  recent: { title: 'My Recent Documents', icon: 'folder', rect: { x: 210, y: 100, width: 610, height: 420 } },
  email: { title: 'New Message', icon: 'mail', rect: { x: 210, y: 80, width: 610, height: 500 } },
  mines: { title: 'Minesweeper', icon: 'app', rect: { x: 340, y: 140, width: 350, height: 410 } },
