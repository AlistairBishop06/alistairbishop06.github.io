...
export function DisplayProperties({ close }: { close: () => void }) {
  ...
  return <div className="display-properties properties-app app-fill">
    ...
    <div className="property-page">
      <div className={`monitor-preview wallpaper-${draft.wallpaper}`}><div style={{ backgroundImage: draft.wallpaper === 'hills' ? "url('./assets/wallpapers/rolling-hills.jpg')" : undefined }}><span>🖥️</span></div></div>
