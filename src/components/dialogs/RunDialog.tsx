...
const commands: Record<string, WindowKind> = { achievements: 'achievements', projects: 'projects', websites: 'websites', about: 'about', contact: 'contact', cv: 'cv', notepad: 'notepad', iexplore: 'browser', cmd: 'cmd', control: 'control', pinball: 'pinball', winver: 'winver' };
